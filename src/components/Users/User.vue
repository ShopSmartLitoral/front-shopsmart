  ...
  methods: {
    ...
    async initialize() {
      ...
      if(this.dataTable) {
        ...
        console.log("[USER_INITIALIZE] Entrou no if: ", this.dataTable);
        return this.users = this.dataTable;
    ...
    async hendleSubmit() {
      ...
      console.log("[HENDLE_SUBMIT_LOG] New User: ", this.newUser);
