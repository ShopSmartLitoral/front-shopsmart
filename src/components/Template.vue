...
export default {
  ...
  data: () => ({
    ...
    items: [
      ...
      { title: "Pedidos", icon: mdiCubeSend, link: "/requests" },
      { title: "Notas Fiscais", icon: mdiFileDocumentMultiple, link: "/nfe" },
  ...
  created() {
    ...
    console.log('Setando o this.user: ', this.user)
  ...
  verifyToken: function() {
    ...
    if(!this.token) return router.push({path: '/'})
  },
   setTime: function() {
    this.verifyToken();
